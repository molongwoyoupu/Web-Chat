  	...
  	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
  			<div class="item active">
  				<img src="image/protal/ic_p4.jpg">
  				<p class="carousel-caption">
  					图片
  				</p>
  			</div>
  			<div class="item">
  				<img src="image/protal/ic_p5.jpg">
  				<p class="carousel-caption">
  					图片
  				</p>
  			</div>
  			<div class="item">
  				<img src="image/protal/ic_p6.jpg">
  				<p class="carousel-caption">
  					图片
  				</p>
  			</div>
  			<div class="item">
  				<img src="image/protal/ic_p7.jpg">
  				<p class="carousel-caption">
  					图片
  				</p>
  			</div>
  			<div class="item">
  				<img src="image/protal/ic_p8.jpg">
  				<p class="carousel-caption">
  					图片
  				</p>
  			</div>
  			<div class="item">
  				<img src="image/protal/ic_p9.jpg">
  				<p class="carousel-caption">
  					图片
  				</p>
  			</div>
  		...
  		<div class="col-xs-4">
  			<div class="panel panel-default" id="pFunc1">
  				<div class="panel-body">
  					<strong>选项一</strong>
  					<img class="iv_function" src="image/protal/ic_store.svg">
  				</div>
  			</div>
  		</div>
  		<div class="col-xs-4">
  			<div class="panel panel-default"  id="pFunc2">
  				<div class="panel-body">
  					<strong>选项二</strong>
  					<img class="iv_function" src="image/protal/ic_remeber.svg">
  				</div>
  			</div>
  		</div>
  		<div class="col-xs-4">
  			<div class="panel panel-default"  id="pFunc3">
  				<div class="panel-body">
  					<strong>选项三</strong>
  					<img class="iv_function" src="image/protal/ic_personal.svg">
  				</div>
  			</div>
  		</div>
  	</div>
  		...
  		<div class="row">
  				...
  				<div class="list-group div_article">
  					...
  					<div class="list-group-item item_article">
  						<div class="row">
  							...
  							<div class="col-xs-3 div_right_info">
  								<img class="iv_article img-rounded" src="image/protal/ic_android1.jpg">
  							</div>
  						</div>
  					</div>
  					<div class="list-group-item item_article">
  					...
  					<div class="list-group-item item_article">
  						<div class="row">
  							...
  							<!-- 右侧图片，信息 -->
  							<div class="col-xs-3 div_right_info">
  								<img class="iv_article img-rounded" src="image/protal/ic_android2.jpg">
  							</div>
  						</div>
  					</div>
  					<div class="list-group-item item_article">
  						<div class="row">
  							...
  							<!-- 右侧图片，信息 -->
  							<div class="col-xs-3 div_right_info">
  								<img class="iv_article img-rounded" src="image/protal/ic_android3.jpg">
  			...
  			<div class="col-xs-3 div_record">
  				...
  				<div class="jumbotron div_userinfo">
  					<img class="iv_user_head img-circle" src="image/protal/ic_p5.jpg">
  					<div id="loginbar" style="display: inline-block; margin-left: 12px;font-size: 18px;">
					您好！欢迎！
					<br/>
