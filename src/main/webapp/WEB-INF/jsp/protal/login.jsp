...
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; ">
			</div>
            <div class="form ">
...
<script type="text/javascript">
	...
	var LOGIN = {
			...
			doLogin:function() {
				$.post("<%=basePath%>dologin", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						//alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "index";
